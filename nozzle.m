%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Nozzle design using method of characteristics for Sprint missile
% Reference: Modern Compressible Flow by John Anderson
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   Problem parameters
T_c = 3644.261;     % Temperature in the combustion chamber (K)
P_c = 2500 * 6894.76;    % Pressure in the combustion chamber (Pa)
P_amb = 8.4560E4;  % Ambient pressure (Pa)
T_amb = 278.41;    % Ambient temperature (K) at burnout
gamma = 1.197;   % Ratio of Specific Heats Cp/Cv (Gamma)
W = 29.356;       % Molecular weight of gas (kg/kmol)
width = sqrt(.0955);     % Nozzle width (meters)
h_th = sqrt(.0955);    % Throat  height (meters)
